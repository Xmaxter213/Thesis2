...
function assistanceCard($patient_ID, $patient_Name, $room_Number, $birth_Date, $reason_Admission, $admission_Status, $assigned_Ward, $assistance_Status, $gloves_ID, $device_ID, $ADL_calls, $max_ADL_response_Time, $IMMEDIATE_calls, $max_IMMEDIATE_response_Time, $pulse_Rate, $date_called, $pulse_Rate_Status, $nurse_contact)
{
