...
if (isset($_POST['add'])) {
    ...
    //Let's get the current website user's assigned ward
        ...
        echo "<script>alert('ID OF CURRENT USER: $staff_ID');</script>";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <a href="PatientsList.php" class="btn btn-secondary float-end active">Admitted Patients List</a>
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-secondary">Admitted Patients Table</h6>
                            <br>
                            <a class="btn btn-secondary float-end" data-toggle="modal" data-target="#addPatientPasswordVerificationModal">Add Patient</a>
<!-- MODAL HERE -->
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="addPatientPasswordVerificationModal">Password Verification</h5>
                                        ...
                                        <div class="modal-body">
                                            <form action="" method="POST">
                                                ...
                                                <button type="submit" class="btn btn-primary" name="verifyAddPatient">Verify Password</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="" method="POST">
                                                                            ...
                                                                            <button type="submit" class="btn btn-primary" name="verifyDischargePatient">Verify Password</button>
                                                                        </form>
                                                                    </div>
                                                                </div>
                                                            </div>
...
<?php
    ...
    if (isset($_POST['verifyAddPatient'])) {
    ...
    if (isset($_POST['verifyDischargePatient'])) {
        $enteredPassword = $_POST['password'];
        $userName = $_SESSION['userID'];
        $ID = $_SESSION['idNUM'];
        $patient_ID = $_POST['patient_ID']; //One to delete
