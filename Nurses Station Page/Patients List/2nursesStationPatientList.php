...
//This code runs after the add_admin.php page i think
if(isset($_POST['add']))
{
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-3">
                        <div class="card-header py-3">
                            ...
                            <a href= "nursesStationAddNurse.php" class="btn btn-primary float-end">Add</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                    ...
                                                    <a href="nursesStationEditNurse.php?nurse_ID=<?= $row['nurse_ID'] ?>" class="btn btn-info">Edit</a>
                                                
                                            </td>

                                            <td>
                                                    <form action="nursesStationDeleteNurse.php" method="POST">
