...
<body id="page-top">
    ...
    <section class="jumbotron text-center">
        <div class="container">
            ...
            <p class="lead text-black">Welcome to our online guide. Here you can find information about how to use
                Helping Hand's Web Application.</p>
            <p class="lead text-black">To get you started, select guides from the cards below of what suits your needs or the
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img src="./Images/gloves.jpg" alt="Your Image" class="bd-placeholder-img card-img-top"
                ...
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img src="./Images/Assistance.jpg" alt="Your Image" class="bd-placeholder-img card-img-top"
                            width="100%" height="225">
                        <div class="card-body">
                            <h4>Assistance Page</h4>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                                additional content. This content is a little bit longer.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="./assistance_Page_Guide.php" class="btn btn-sm btn-outline-secondary">View
                                        Guide</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img src="./Images/nurses.jpg" alt="Your Image" class="bd-placeholder-img card-img-top"
                            width="100%" height="225">
                        <div class="card-body">
                            <h4>Nurses List</h4>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="./nurses_List_Guide.php" class="btn btn-sm btn-outline-secondary">View Guide</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img src="./Images/patients.jpg" alt="Your Image" class="bd-placeholder-img card-img-top"
                            width="100%" height="225">
                        <div class="card-body">
                            <h4>Patient List</h4>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="./patient_List_Guide.php" class="btn btn-sm btn-outline-secondary">View Guide</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img src="./Images/reports.jpg" alt="Your Image" class="bd-placeholder-img card-img-top"
                            width="100%" height="225">
                        <div class="card-body">
                            <h4>Reports Page</h4>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="./reports_Guide.php" class="btn btn-sm btn-outline-secondary">View Guide</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img src="./Images/logs.jpg" alt="Your Image" class="bd-placeholder-img card-img-top"
                            width="100%" height="225">
                        <div class="card-body">
                            <h4>Logs Page</h4>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <a href="./logs_Guide.php" class="btn btn-sm btn-outline-secondary">View Guide</a>
                                </div>
                            </div>
                        </div>
                    </div>
