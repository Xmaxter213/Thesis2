...
if (isset($_POST['nurseRestore'])) {
    $nurse_ID = $_POST['nurseRestore'];

    //Restore nurse account
    $queryReactivateAccount = "UPDATE staff_List SET activated = '1', delete_at = NULL WHERE nurse_ID = '$nurse_ID'";
    ...
    if ($query_reactivate_run && $query_remove_delete_run) {
         ...
         if ($query_run_logs) 
        {
            ...
            header('Location: RestoreNurse.php');
            exit(0);
        } 
        else 
        {
                    ...
                    <div class="card shadow mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                FROM staff_List JOIN staff_List_Trash ON staff_List.nurse_ID=staff_List_Trash.nurse_ID WHERE staff_List.hospital_ID = '$hospital_ID' ORDER BY staff_List.nurse_ID  LIMIT $start, $limit");
                                $nurses = $result->fetch_all(MYSQLI_ASSOC);

                                $result1 = $con->query("SELECT count(nurse_ID) AS nurse_ID FROM staff_List WHERE activated = 0 AND hospital_ID = $hospital_ID");
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="modal fade" id="restore<?= $nurse['nurse_ID'] ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel">Restore Nurse</h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        Are you sure you want to restore this nurse account?
                                                                        <form action="RestoreNurse.php" method="POST"> 
                                                                    </div>
